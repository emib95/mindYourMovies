                ...
                messages=[
                    {
                        ...
                        "content": (
                            ...
                            "If the user asks for something similar to or like a named "
                            "title, choose a different candidate with a close tonal, "
                            "genre, era, or reputation match. If the user names a specific "
                            "title as the movie they want and that title is in the "
                            "candidate list, strongly prefer it. If the named title is not "
                            "available, choose a close match. "
